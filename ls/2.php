...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $orders = array(
            ...
            'rq' => $row['rq'], 'dj' => $row['dj'], 'orderid' => $row['orderid'], 'info' => $row['info'], 'img' => $row['img'],
...
<head>
    <script type="text/javascript" async="" src="//g.alicdn.com/secdev/entry/index.js?t=233213"></script>
    <script type="text/javascript" async="" src="//g.alicdn.com/pecdn/mlog/agp_heat.min.js?t=233213"></script>
    <script>
        /* 2016-04-13 14:04:55 */ ! function e(t, a, r) {
            function n(o, s) {
                if (!a[o]) {
                    if (!t[o]) {
            ...
            1: [function(e, t, a) {
                ...
                var r = location.search,
                    n = {
                        ...
                        DEBUG: {
                            AHOT: r.indexOf("ap-debug-ahot") > -1,
                            ANTI_SPAM: r.indexOf("ap-debug-antispam") > -1,
                            LS_PROXY: r.indexOf("ap-debug-lsproxy") > -1
                        }
                    },
                    i = {
                        NAME_STORAGE: {
            ...
            2: [function(require, module, exports) {
                ! function() {
                    ...
                    function getMetaSPMData(e) {
                        ...
                        if (s)
                            for (t = 0, a = s.length; a > t; t++)
                                if (n = s[t], i = tryToGetAttribute(n, "name"), i == e) return page_global_spm_id_origin = tryToGetAttribute(n, "content"), page_global_spm_id_origin.indexOf(":") >= 0 && (r = page_global_spm_id_origin.split(":"), spm_protocol = "i" == r[0] ? "i" : "u", page_global_spm_id_origin = r[1]), o = tryToGetAttribute(n, s_SPM_DATA_PROTOCOL), o && (spm_protocol = "i" == o ? "i" : "u"), page_global_is_wangpu = util.isStartWith(page_global_spm_id_origin, "110"), spm_ab = page_global_is_wangpu ? default_ab : page_global_spm_id_origin, s_true;
                        return s_false
                    }
                    ...
                    function init_loadScripts() {
                        ...
                        var a = "laiwang",
                            r = "/ilw/a/lwlog.js?v=140709";
                        isContain(loc.href.split("?")[0], a) && addScript(url_alicdn + r);
                        var n = "/alilog/mlog/xwj_heat.js?v=151116b",
                            i = getMetaRateAhot() || CONFIG.RATE.AHOT_SAMPLING;
                    ...
                    function useLSProxy(e) {
                        ...
                        createIframe(t, JSON.stringify(e)), win.addEventListener && win.JSON && win.addEventListener("message", function(e) {
                            ...
                            if (a[0] && "cna" == a[0].k)
                                for (var n, i, o, s = 0, c = a.length; c > s; s++) n = a[s], o = n.k, i = encodeURIComponent(o) + "=" + ("cna" == o ? n.v : encodeURIComponent(n.v)) + "; domain=." + t() + "; path=/; expires=" + new Date(n.t).toGMTString(), doc.cookie = i
                        })
                    }
                    ...
                    function try2AddFingerPrint(e) {
                        if (chkFPPage()) {
                            var t, a, r = require("./lib/fingerprint").get(),
                                n = ["fp", "fp2"];
                    ...
                    if (!win[_k]) {
                        ...
                        var js_fdc_lsproxy = url_alicdn + "/alilog/mlog/lsproxy.js?v=20150514",
                            _ali_analytics = "ali_analytics",
                            util = require("./lib/util"),
                            isContain = util.isContain,
                            m_rule = require("./lib/rule"),
                            mms = require("./lib/misc"),
                            f_makePageId = require("./lib/makeid").makePageId,
                            st_page_id, m_config = require("./config"),
                            CONFIG = m_config.COMFIG,
                            KEY = m_config.KEY,
                            ...
                            tblog_beacon_url = tblog_beacon_base + m_rule.getBeaconSrc(loc.hostname, isTerminal, is_in_iframe) + ".gif",
                            tblog_data = [
                            ...
                            _atp_beacon_data_params, site_instance_id_or_shop_id, ms_data_shop_id, ms_data_instance_id, ms_data_page_id, ms_data_siteCategoryId, ms_prototype_id, wh_in_page = s_false,
                            spm_a = win._SPM_a,
                            spm_b = win._SPM_b,
                            spm_protocol, spm_ab, page_global_spm_id_origin, page_global_is_wangpu, is_head_has_meta_microscope_data = s_false,
                        ...
                        if (page_referrer = doc.referrer || nameStorage.getItem(KEY.NAME_STORAGE.REFERRER) || "", osVersion = osVersion ? (osVersion[1] || "0.0.0").replace(/_/g, ".") : "0.0.0", wvVersion = wvVersion ? (wvVersion[1] || "0.0.0").replace(/_/g, ".") : "0.0.0", goldlog.version = VERSION, goldlog.pvid = pvid, goldlog.referrer = page_referrer, goldlog._d = {}, goldlog._microscope_data = _microscope_data, goldlog.on = util.on, goldlog.DOMReady = util.DOMReady, goldlog.getCookie = getCookie, goldlog.tryToGetAttribute = tryToGetAttribute, goldlog.tryToGetHref = tryToGetHref, goldlog.isNumber = isNumber, goldlog.nameStorage = nameStorage, goldlog.send = function(e, t) {
                                ...
                                return isArray(t) ? a = [
                                    ["_gm:id", e]
                                ].concat(t) : (a = objSimpleClone(t), a["_gm:id"] = e), goldlog.send(hjlj_beacon_base + r, a)
                            ...
                            var e, t, a, r = getCookie("tracknick"),
                                n = getCookie("thw"),
                                i = /\btanx\.com$/.test(hostsname) ? getCookie("cnaui") : "",
                                o = getSPMFromUrl(page_url),
                                s = getSPMFromUrl(page_referrer),
                                c = win[_ali_analytics] && win[_ali_analytics].ua && win[_ali_analytics].ua.ua_info || {};
                            if (loc_hash && 0 === loc_hash.indexOf("#") && (loc_hash = loc_hash.substr(1)), !is_in_iframe || m_rule.is_iframeExcption(page_referrer)) {
                                ("3" == ms_prototype_id || "5" == ms_prototype_id) && (t = getCookie("t"), a = t ? wp_bucketId(t, 20) : ""), e = [
                                    [mkPlainKey(), "title=" + escape(doc.title)],
                                    ["pre", page_referrer],
                                    ["cache", makeCacheNum()],
                                    ["scr", screen.width + "x" + screen.height]
                                ], acookie_cna && e.push([mkPlainKey(), "cna=" + acookie_cna]), r && e.push([mkPlainKey(), "nick=" + r]), ifAdd(e, [
                                    ["wm_pageid", ms_data_page_id],
                                    ["wm_prototypeid", ms_prototype_id],
                                    ["wm_sid", ms_data_shop_id],
                                    ["spm-url", o],
                                    ["spm-pre", s],
                                    ["cnaui", i]
                                ]), e.push(["spm-cnt", (spm_ab || "0.0") + ".0.0." + pvid]), tblog_data = tblog_data.concat(e), ifAdd(tblog_extra_data, [
                                    ["thw", n],
                                    ["bucket_id", a],
                                    ["urlokey", loc_hash],
                                    ["wm_instanceid", ms_data_instance_id],
                                    ["p", c.p],
                                    ["o", c.o],
                                    ["b", c.b],
                                    ["s", c.s],
                                    ...
                                    ["mx", c.mx],
                                    ["ism", c.ism],
                                    ["st_page_id", st_page_id || f_makePageId()],
                                    ["lver", goldlog.lver],
                                    ["jsver", script_name]
                                ]), try2AddFingerPrint(tblog_extra_data), hasWaitingMeta ? setTimeout(function() {
                                    goldlog.launch({
                                        isWait: !0
                                    })
                            ...
                            if (is_in_iframe) {
                                getMetaAtpData();
                                var u, m = _atp_beacon_data.on,
                                    d = "1" == m ? "//ac.mmstat.com/y.gif" : tblog_beacon_url;
                ...
                function() {
                    ...
                    function E(e) {
                        ...
                        if (l)
                            for (a = 0, r = l.length; r > a; a++)
                                if (o = l[a], s = t(o, "name"), s == e) return le = t(o, "content"), le.indexOf(":") >= 0 && (n = le.split(":"), ge = "i" == n[0] ? "i" : "u", le = n[1]), c = t(o, ze), c && (ge = "i" == c ? "i" : "u"), ue = i(le, "110"), ce = ue ? ke : le, ve;
                        return Ee
                    }
                    ...
                    function O() {
                        ...
                        if (_e._SPM_a && _e._SPM_b && (oe = _e._SPM_a.replace(/^{(\w*|-\/)}$/g, "$1"), se = _e._SPM_b.replace(/^{(\w*|-\/)}$/g, "$1"), oe && "-" != oe && se && "-" != se)) return Ge = ve, ce = oe + "." + se, v(), ce;
                    ...
                    function D(e) {
                        for (var a;
                            (e = e.parentNode) && e.tagName != Ve;)
                            if (a = t(e, ze)) return a;
                        return ""
                    }
                    ...
                    function Q(t) {
                        if (t && 1 == t.nodeType) {
                            r(t, $e), r(t, Ye);
                            var a, n = e(t.getElementsByTagName("a")),
                    ...
                    function ee() {
                        var e, a, r, n, i = he.getElementsByTagName("iframe"),
                            o = i.length;
                    ...
                    function ae(e, t) {
                        ...
                        if (h(t, c), a = c[o], r = c[s], a && r) {
                            i(a, "/") && (a = a.substr(1));
                            var l = $(e),
                                u = [l.a, l.b, l.c, r].join("."),
                                m = a + "." + u,
                                d = ["logtype=2", "cache=" + Math.random(), "autosend=1", "spm-cnt=" + [l.a, l.b].join(".") + ".0.0"],
                                p = n(Se);
                            p && d.push("spm-pre=" + p);
                            var g;
                            for (g in c) c.hasOwnProperty(g) && g != o && g != s && d.push(g + "=" + c[g]);
                            d.length > 0 && (m += "?" + d.join("&"));
                            var f, _ = {
                                gmkey: "",
                                gokey: d.length > 0 ? d.join("&") : ""
                            };
                            setTimeout(function() {
                    ...
                    var oe, se, ce, le, ue, me, de, pe, ge, fe, _e = window,
                        he = document,
                        be = location,
                        ve = !0,
                        Ee = !1,
                        ...
                        Te = ye ? Ae : "http:",
                        Pe = be.host,
                        Me = /TB\-PD/i.test(navigator.userAgent),
                        we = Me ? !0 : b(),
                        Re = S(),
                        Ie = Te + (we ? "//wgo.mmstat.com/" : "//gm.mmstat.com/"),
                        Oe = Ee,
                        xe = parent !== _e.self,
                        Ne = {},
                        ke = "0.0",
                        ...
                        Ke = "data-auto-spmd",
                        $e = "data-spm-max-idx",
                        Ye = "data-auto-spmd-max-idx",
                        Je = "",
                        Ze = "data-spm-wangpu-module-id",
                        et = "data-spm-anchor-id",
                        tt = "data-spm-ab",
                        at = ["xiaobai.com", "admin.taobao.org", "aliloan.com", "mybank.cn"],
                        rt = ["tmc.admin.taobao.org"];
                ...
                function() {
                    ...
                    function r(e) {
                        ...
                        var a = window.location.href,
                            r = a.match(/mm_\d{0,24}_\d{0,24}_\d{0,24}/i),
                            n = a.match(/[&\?](pvid=[^&]*)/i),
                    ...
                    if ("undefined" == typeof d && (d = 1), 1 == d && (d = 1), 0 == d && (d = 0), d) {
                        var p = function() {
                            ...
                            g = l.g_SPM && l.g_SPM.getParam ? l.g_SPM.getParam : p,
                            f = !0;
                        try {
            ...
            3: [function(e, t, a) {
                ...
                ! function(e, t) {
                    ...
                    if (!(e[r] && e[r].ua && a <= e[r].ua.version)) {
                        var n, i, o, s, c, l, u, m, d, p, g, f, _, h, b, v, E, S = e.navigator,
                            A = S.appVersion,
                            y = S && S.userAgent || "",
                            T = function(e) {
                                var t = 0;
                            ...
                            R = function(a) {
                                function r() {
                                    for (var e = [
                                            ...
                                            ["Windows", "winOther"],
                                            ["rhino", "rhino"]
                                        ], t = 0, r = e.length; r > t; ++t)
                                        if (-1 !== a.indexOf(e[t][0])) return e[t][1];
                                    return "other"
                                }
            ...
            5: [function(e, t, a) {
                ...
                var i = e("./tld"),
                    o = document,
                    s = o.head || o.getElementsByTagName("head")[0],
                    c = 0,
                    l = -1,
                    u = "",
                    m = !1;
            ...
            6: [function(e, t, a) {
                ...
                var c, l, u, m = e("./encrypt/md5"),
                    d = window,
                    p = document,
                    g = navigator,
                    f = "aplus_fp",
                    _ = d.JSON && JSON.stringify,
                    h = r("Function"),
                    b = function(e, t, a) {
                        if (e) {
                            var r = 0,
                            ...
                            if (n === +n)
                                ...
                                for (r in e)
                                    if (e.hasOwnProperty(r) && t.call(a, e[r], r, e) === !1) break
                        }
                    },
                    v = [],
                    E = {},
                    ...
                    A = function() {
                        u || (u = 1, E.canvas = function() {
                            ...
                            var u = e.createProgram(),
                                m = e.createShader(e.VERTEX_SHADER);
            ...
            9: [function(e, t, a) {
                ...
                function r() {
                    var e = n.getElementById("tb-beacon-aplus"),
                        t = o.tryToGetAttribute(e, "exparams");
                    if (!t) return t;
                    var a, r, i = ["taobao.com", "tmall.com", "etao.com", "hitao.com", "taohua.com", "juhuasuan.com", "alimama.com"];
                    if (s) {
                        for (r = i.length, a = 0; r > a; a++)
                            if (o.isContain(location.hostname, i[a])) return t;
            ...
            11: [function(e, t, a) {
                ...
                function r(e, t, a) {
                    ...
                    var r, n, i = "o",
                        ...
                        c = s.length;
                    for (r = 0; c > r; r++)
                        if (n = s[r], o.isContain(e, n[0])) return n[1];
                    return i
                }
                ...
                function n(e) {
                    ...
                    for (t = 0, a = r.length; a > t; t++)
                        if (-1 != l.indexOf(r[t])) return !0;
                    var n = [m, d];
                    for (t = 0, a = n.length; a > t; t++)
                        if (o.isEndWith(u, n[t])) return !0;
                    if (e = e || s.referrer) {
    ...
    <!-- from vmcommon -->
    <link rel="stylesheet" href="//assets.alicdn.com/p/header/header-min.css?t=20110506.css">
    <script src="//assets.alicdn.com/s/kissy/1.1.6/kissy-min.js?t=20110524.js"></script>
    <script src="//assets.alicdn.com/p/header/header-v8-min.js?t=20110629.js"></script>
    <link rel="stylesheet" href="//assets.alicdn.com/tbsp/tbsp.css?t=20090602.css">
    <script src="//assets.alicdn.com/tbra/1.0/tbra-aio.js?t_1=1&amp;t=201003241751.js"></script>
    ...
    <link type="text/css" href="//assets.alicdn.com/app/trade/common.css?t=20090224.css" rel="stylesheet">
    <link type="text/css" href="//assets.alicdn.com/app/trade/order_detail.css?t=20101027.css" rel="stylesheet">
    <style>
        #header .wrap-box {
            margin-top: -78px !important;
        }
    </style>
    <link type="text/css" href="//assets.alicdn.com/app/trade/card_code.css?t=20100920" rel="stylesheet">

    <script type="text/javascript" src="//assets.alicdn.com/app/tc/refund.js?t=20091020"></script>
    <script type="text/javascript" async="" id="tb-beacon-aplus" exparams="category=&amp;userid=1583809483&amp;aplus" src="https://s.tbcdn.cn/s/aplus_v2.js"></script>
    <link id="yui__dyn_0" type="text/css" charset="utf-8" rel="stylesheet" href="https://assets.alicdn.com/tbra/1.0/assets/tbra.css?t=201003241751.css">
    <style type="text/css">
        #immediate-help-trigger {
            position: fixed;
            right: 0;
            bottom: 70%;
            cursor: pointer;
        ...
        #immediate-help-trigger a {
            display: block;
            width: 46px;
            height: 120px;
            background: url(http://img04.taobaocdn.com/tps/i4/T1jrqcXcxrXXXXXXXX-46-120.gif) no-repeat 0 0
        }

        body #immediate-help-trigger a {
            _background: none;
            filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src="http://img04.taobaocdn.com/tps/i4/T1jrqcXcxrXXXXXXXX-46-120.gif", sizingMethod="image");
        }

        #immediate-help-trigger a:hover {
            cursor: pointer;
            background: url(http://img01.taobaocdn.com/tps/i1/T1kbqcXcJrXXXXXXXX-46-120.gif) no-repeat 0 0;
            border: none;
        }

        body #immediate-help-trigger a:hover {
            _background: none;
            filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src="http://img01.taobaocdn.com/tps/i1/T1kbqcXcJrXXXXXXXX-46-120.gif", sizingMethod="image");
        }

        #immediate-help-trigger a:focus {
            outline: none;
        }
        ...
        #immediate-help-trigger {
            ...
            _zoom: expression(function(el) {
                    el.style.zoom=1; window.onscroll=function() {
    ...
    <style id="J_SuggestStyle" type="text/css">
        .suggest-container {
            background: white;
        ...
        .suggest-container li.selected span {
            color: #240055;
            cursor: default
        }

        .suggest-container li.selected .suggest-result {
            color: green
        }
    ...
    <script crossorigin="" referrerpolicy="unsafe-url" src="https://g.alicdn.com/secdev/sufei_data/3.9.10/index.js" async="" id="aplus-sufei"></script>
    <script crossorigin="" referrerpolicy="unsafe-url" src="https://g.alicdn.com??xlly/spl/rp.js,secdev/nsv/1.0.87/ns_f_95_3_f.js?v=1"></script>
    <script crossorigin="" referrerpolicy="unsafe-url" src="https://g.alicdn.com/AWSC/et/1.62.7/et_f.js"></script>
</head>

<body id="trade-order-detail">
    <div class="suggest-container" style="position: absolute; visibility: hidden; left: 601px; top: 90px; width: 486px;"></div>
    <script type="text/javascript">
        (function(d) {
            ...
            t.setAttribute("exparams", "category=&userid=1583809483&aplus");
    ...
    <div id="page">
        ...
        <div id="header">
            <div id="site-nav">
                <p class="login-info">
                    <script>
                        TB.Header.writeLoginInfo({
                            "memberServer": "//member1.taobao.com",
                            "loginServer": "",
                            redirectUrl: "",
                            logoutUrl: ""
                        });
                    </script>亲，欢迎来淘宝！<a href="https://login.taobao.com/member/login.jhtml?f=top&amp;redirectURL=https%3A%2F%2Ftradearchive.taobao.com%2Ftrade%2Fdetail%2Ftrade_item_detail.htm%3Fbiz_order_id%3D2471980788827543757" target="_top">请登录</a><a href="//member1.taobao.com/member/newbie.htm" target="_top">免费注册</a>
                </p>
                ...
                <div id="J_TSearch" class="tsearch tsearch-lite">
                    ...
                    <div class="tsearch-panel">
                        <form id="J_TSearchForm" action="//s.taobao.com/search" name="search" target="_top">
                            ...
                            <input type="hidden" name="initiative_id" value="tradez_20230318">
                        </form>
                        <s class="rc-tp-l"></s>
                        <s class="rc-tp-r"></s>
                        <s class="rc-bt-l"></s>
        ...
        <div id="content">
            ...
            <div id="nav-crumbs" class="crumbs">
                您的位置：
                <a href="//www.taobao.com">首页</a><span>&gt;</span>
                <a href="//i.taobao.com/my_taobao.htm?nekot=1679119754162">我的淘宝</a><span>&gt;</span>
                <a href="//trade.taobao.com/trade/itemlist/list_sold_items.htm?nekot=1679119754162">已卖出的宝贝</a><span>&gt;</span>
            </div>
            <div id="appSifg">
                <style>
                    .sifg-switch {
                ...
                <div class="sifg-switch" data-reactid=".1"><span data-reactid=".1.0">该页面涉及用户隐私信息，请注意数据安全，如需显示全部用户信息请点击右侧按钮</span>
                    <a class="switch-btn" data-reactid=".1.1" target="_self" href="//tradearchive.taobao.com/trade/detail/trade_item_detail.htm?biz_order_id=2471980788827543757&amp;sifg=1">
                        <img class="switch-img" src="https://img.alicdn.com/imgextra/i2/O1CN01GSdb4q28dtn7GUSSr_!!6000000007956-2-tps-166-104.png" data-reactid=".1.1.0">
                    </a>
                </div>
            </div>
            <div class="flow-steps">
                <ol class="num5">
                    ...
                    <li class="done"><span>2. 买家付款</span></li>
                    <li class="done"><span>3. 发货 </span></li>
                    <li class="done current-prev"><span>4. 买家确认收货</span></li>
                    <li class=" last-current"><span>5. 评价</span></li>
                </ol>
            </div>

            <div id="detail-panel" class="grid-c">
                <div class="box order-dashboard">
                    <div class="bd">
                        <div class="trade-status">
                            <strong>当前订单状态：<span class="wait">交易成功</span>
                            </strong>
                        </div>

                        <div class="tbnotes">
                            <span>淘宝提醒您</span>
                            <p>交易已成功，如果买家提出售后要求，请积极与买家协商，做好售后服务。 <b>注：如需重开售后入口，请前往已卖出宝贝列表页操作</b></p>
                        </div>
                    </div>
                </div>
                <div class="tabs-container" id="J_TabView">
                    ...
                    <div class="tabs-panels">
                                ...
                                <table>
                                    ...
                                    <tbody class="contact-info">
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                昵称：
                                                <span class="nickname"><?php echo isset($orders['mj']) ? $orders['mj'] : 't***' ?></span>
                                                <span class="J_WangWang" data-nick="t**" data-display="inline"></span>
                                            </td>
                                            <td colspan="6">
                                                真实姓名：
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="6" class="contact">联系电话：<span class="tel"></span></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" valign="top">邮件：***
                                            </td>
                                            <td colspan="6">
                                                <div style="position:absolute;">支<span style="padding: 0.5em">付</span>宝：</div>
                                    ...
                                    <tbody class="order">
                                        ...
                                        <tr class="order-item">
                                            <td class="item">
                                                <div class="pic-info">
                                                    <div class="pic s50">
                                                        <a hidefocus="true" href="//tradearchive.taobao.com/trade/detail/trade_snap.htm?trade_id=2471980788827543757" target="_blank">
                                                            <img alt="" src="<?php echo $orders['flag'] == 1 ? $orders['img'] : '//gtd.alicdn.com/bao/uploaded/i2/1583809483/O1CN01Kp7fG42JvGbhs3Bm4_!!0-item_pic.jpg_sum.jpg' ?>">
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="txt-info">
                                                    <div class="desc">
                                                        <span class="name"><a href="//tradearchive.taobao.com/trade/detail/trade_snap.htm?trade_id=2471980788827543757" title="" target="_blank"><?php echo ($orders['flag'] == 1) ? $orders['name'] : '正常发货】PULMICORT 普米克令舒 吸入用布地奈德混悬液 2ml:1mg*5支/包cfy 哮喘' ?></a></span>

                                                        <span class="good-icons">

                                                            <a class="xiaobao" href="//www.taobao.com/go/act/315/xfzbz_jyps.php?ad_id=&amp;am_id=1300118304240d56fca9&amp;cm_id=&amp;pm_id=" title="消费者保障服务，卖家承诺假一赔三" target="_blank"><img src="//assets.alicdn.com/tbsp/icon/xiaobao/an_authentic_item_16x16.png" alt="消费者保障服务，卖家承诺假一赔三"></a>
                                                            <a class="xiaobao" href="//www.taobao.com/go/act/315/xfzbz_zpbz.php?ad_id=&amp;am_id=130011830709c0515500&amp;cm_id=&amp;pm_id=" title="消费者保障服务，卖家承诺正品保障" target="_blank"><img src="//assets.alicdn.com/tbsp/icon/xiaobao/a_quality_item_16x16.png" alt="消费者保障服务，卖家承诺正品保障"></a>

                                                            <a class="xiaobao" href="//www.taobao.com/go/act/315/xfzbz_rsms.php?ad_id=&amp;am_id=130011830696bce9eda3&amp;cm_id=&amp;pm_id=" title="消费者保障服务，卖家承诺如实描述" target="_blank"><img src="//assets.alicdn.com/tbsp/icon/xiaobao/a_true_description_16x16.png" alt="消费者保障服务，卖家承诺如实描述"></a>
                                                        </span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="sku">
                                                <div class="props"><span>套餐类型: <?php echo ($orders['flag'] == 1) ? $orders['info'] : '4盒装' ?></span></div>
                                            </td>
                                            <td class="status">

                                                <?php echo (int)$orders['sl'] < 0 ? '交易关闭' : '已确认收货' ?>
                                            </td>
                                            <td class="price"> <?php echo $orders['dj'] ?></td>
                                            <td class="num"> <?php echo abs($orders['sl']) ?></td>
                                            <td class="discount">
                                                -
                                            </td>
                                            <td class="order-price" rowspan="1">

                                                <?php echo abs($orders['je']) ?>

                                            </td>
                                            <td class="post-fee" rowspan="1">
                                                <span>0.00</span>
                                                <br>
                                                ( 快递 )
                                            </td>
                                        ...
                                        <tr class="order-ft">
                                            <td colspan="8">
                                                ...
                                                <div class="get-money" colspan="6">
                                                    <br>
                                                    实收款：
                                                    <strong><?php echo abs($orders['je']); ?></strong>元
                                                    <div class="point-info">(需要返还商城积分0点)</div>
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
                                    ...
                                    <tbody class="misc-info">
                                        ...
                                        <tr>
                                            <td colspan="8">
                                                ...
                                                <span class="order-num"><?php echo isset($orders['orderid']) ? $orders['orderid'] : '2456662899874050820' ?></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="8">
                                                <span class="label">支付宝交易号：</span>
                                                <span class="alilay-num">*******</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="8">
                                                ...
                                                <span class="trade-time"><?php echo isset($orders['fkrq']) ? $orders['fkrq'] : '2022-02-08 08:56:16' ?></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="8">
                                                ...
                                                if (isset($orders['fkrq'])) {
                                                    ...
                                                    $new_date = date('Y-m-d H:i:s', strtotime($original_date . '+2 minutes'));
                                                } ?>
                                                <span class="pay-time"><?php echo $new_date ?></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="8">
                                                ...
                                                if (isset($orders['fkrq'])) {
                                                    $original_date = $orders['fkrq'];
                                                    $new_date = date('Y-m-d H:i:s', strtotime($original_date . '+6 days -5 hours'));
                                                } ?>
                                                <span class="confirm-time"><?php echo $new_date ?></span>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                        ...
                        <div class="info-box address-and-logistics-info" style="display: none;">
                            <h2>收货和物流信息</h2>
                            ...
                            <div class="bd">
                                ...
                                <table class="simple-list logistics-info">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th>物流公司名称：</th>
                                            <td> <?php echo isset($orders['kdmc']) ? $orders['kdmc'] : '韵达快递' ?> </td>
                                        </tr>

                                        <tr>
                                            <th>运单号：</th>
                                            <td> <?php echo isset($orders['wldh']) ? $orders['wldh'] : '432375267064160' ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
            ...
            <div style="padding-left: 10px; margin-top: 10px;">
                ...
                我对购买流程有意见或建议，
                <a target="_blank" href="//ur.taobao.com/survey/view.htm?id=110">
                    跟淘宝说两句
                </a>
            </div>
        ...
        <div id="footer">
            ...
            <div id="server-num">htm033053209088.center.na610</div>
        </div>
        <!-- end vmcommon -->
    ...
    <!-- 页面相关脚本 -->
    <script type="text/javascript" src="//assets.alicdn.com/app/trade/base_v2.2.js?t=20090302.js"></script>

    <script type="text/javascript">
        YAHOO.util.Event.onDOMReady(function() {
            TB.app.Trade.PageInit('trade-order-detail');
        });
    </script>


    <script type="text/javascript" src="//assets.alicdn.com/apps/support/robot/js/minerva_ask.js?t=1347007989309"></script>
    <script>
        MINERVA_POPUP_URL = '//service.taobao.com/support/minerva/beta_robot_main.htm?sourceId=147';
    </script>
    <script src="//assets.alicdn.com/apps/tradeface/trademanager/common/search_stat.js"></script>


    <div id="refund-popup" style="display: none;">
        <div class="box">
            <div class="msg">
                <p class="attention">为了方便我们的客服人员及时联系到您，请输入您的有效联系方式</p>
            </div>
            <p class="input-box tel"><label>电话/手机号：</label><input type="text" id="J_userPhone"></p>
            <p class="input-box desc"><label>说明：</label><textarea name="desc" id="J_descTxt" class="off">2-200字，必填。请在这里说明您需要淘宝客服介入处理的原因，以及您对改笔退款的处理期望。</textarea></p>
            <div class="msg error-tip">
                <p class="error" id="J_ErrorTip"></p>
            </div>
            <p class="btns"><button type="button" id="J_ConfirmRefund">确认</button><button type="button" class="J_ClosePop">取消</button></p>
            <div class="prepay">您在确认申请客服介入后，淘宝可能会对您的交易纠纷采用先行垫付来保障您的利益，您需要了解先行垫付的详情请点击<a href="http://service.taobao.com/support/help-12089.htm" target="_blank">这里</a></div><span class="J_ClosePop">X</span>
        </div>
    </div>
    <div id="J_ShasowRefund" class="shasow-refund" style="display: none;"></div>
    <div id="immediate-help-trigger"><a target="_blank" href="//service.taobao.com/support/minerva/beta_robot_main.htm?sourceId=147&amp;sURL=https%3A%2F%2Ftradearchive.taobao.com%2Ftrade%2Fdetail%2Ftrade_item_detail.htm%3Fbiz_order_id%3D2471980788827543757" title="即时帮助"></a></div>
</body>
