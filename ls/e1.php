...
<head>
    ...
    <meta name="spm-id" content="a21dvs">
    ...
    <script type="text/javascript" async="" src="https://g.alicdn.com/alilog/aplus_plugin_xwj/index.js?t=233261"></script>
    ...
    <script crossorigin="anonymous" src="https://g.alicdn.com/??mtb/lib-mtop/2.6.1/mtop.js,code/lib/react/17.0.1/umd/react.production.min.js,code/lib/react-dom/17.0.1/umd/react-dom.production.min.js,code/lib/moment.js/2.27.0/moment-with-locales.min.js"></script>
    <script crossorigin="anonymous" src="https://g.alicdn.com/code/lib/alifd__next/1.25.34/next.min.js"></script>
    <script crossorigin="anonymous" src="//gw.alipayobjects.com/os/lib/react-router-dom/5.2.0/umd/react-router-dom.min.js"></script>
    <link crossorigin="anonymous" href="//gw.alipayobjects.com/os/lib/alife/theme-sellerpc/0.6.5/??variables.css,dist/next.var.min.css" rel="stylesheet">

    <link rel="stylesheet" href="//g.alicdn.com/ascp-design/ascp-design/8.1.64/theme/ascp-base.css">
    <link rel="stylesheet" href="https://at.alicdn.com/t/font_1613397_gk7riwodrrm.css">
    ...
    <script>
        window.is_vm = true;
        window._x_frames_allow_from_ = "wuliu2";
        window.componentName = 'consign-detail';
        window._env_ = 'prod'
    </script>

    <script>
        var defaultDomainConfig = {
            "templateName": "home.html",
            "logo": "https://gw.alicdn.com/imgextra/i3/O1CN01XoUmCn1DN16agz3Yh_!!6000000000203-2-tps-255-150.png",
            "name": "taobao"
        }
        ...
        function parseConfig(val) {
            try {
                return JSON.parse(htmlDecode(val))
            } catch (e) {
    ...
    <link href="https://o.alicdn.com/crs-qn/microapp-loader/MicroLoader.css" rel="stylesheet">
    <script crossorigin="anonymous" src="https://o.alicdn.com/crs-qn/microapp-loader/MicroLoader.js"></script>
    <script type="text/javascript" src="https://o.alicdn.com/x-bridge/qn-sdk/qn.min.js"></script>
    <script async="" src="//log.mmstat.com/eg.js?t=1679484151441"></script>
    <link href="https://g.alicdn.com/merchant-micro-apps/consign-detail/0.0.42/css/main.css" rel="stylesheet">
    <script src="https://g.alicdn.com/merchant-micro-apps/consign-detail/0.0.42/js/main.js" type="text/javascript" async="" crossorigin="anonymous"></script>
    <script async="" src="//log.mmstat.com/eg.js?t=1679484152548"></script>
</head>

<body data-spm="23850806">
    <script id="tb-beacon-aplus" src="//g.alicdn.com/alilog/mlog/aplus_v2.js" exparams="category=&amp;userid=2211413643072&amp;aplus&amp;yunid=&amp;5963317578635&amp;trid=0bfb837316230366603911831e1d2f&amp;asid=AUBPhuL0kr1gl9DSNAAAAADGSVR+5/kp/g=="></script>
    <script id="tb-beacon-aplus" src="//g.alicdn.com/alilog/mlog/aplus_v2.js" exparams="category=&amp;userid=1583809483&amp;aplus&amp;yunid=&amp;5e3e83e8e653e&amp;trid=213e204316794841506704847e9913&amp;asid=AcsDZ1725BpkuMszBgAAAABiznHB0A/0TA=="></script>
    <script>
        with(document) with(body) with(insertBefore(createElement("script"), firstChild)) setAttribute("exparams", "category=&userid=1583809483&aplus&yunid=&5e3e83e8e653e&trid=213e204316794841506704847e9913&asid=AcsDZ1725BpkuMszBgAAAABiznHB0A/0TA==", id = "tb-beacon-aplus", src = (location > "https" ? "//g" : "//g") + ".alicdn.com/alilog/mlog/aplus_v2.js")
    </script>

    <script>
        with(document) with(body) with(insertBefore(createElement("script"), firstChild)) setAttribute("exparams", "category=&userid=2211413643072&aplus&yunid=&5963317578635&trid=0bfb837316230366603911831e1d2f&asid=AUBPhuL0kr1gl9DSNAAAAADGSVR+5/kp/g==", id = "tb-beacon-aplus", src = (location > "https" ? "//g" : "//g") + ".alicdn.com/alilog/mlog/aplus_v2.js")
    </script>

    <div id="microapp-container">
        <div class="next-loading next-loading-inline" style="width: 100%; height: 100%;">
            <div class="next-loading-wrap">
                <div class="page-container">
                    <div></div>
                    <div style="width: 100%;">
                        <div class="flex flex-justify-between" style="padding: 20px 0px; border-bottom: 1px solid rgb(229, 229, 229);">
                            <div>
                                <div class="flex">
                                    <div class="flex flex-align-center" style="margin-right: 50px; margin-top: 0px; font-size: 14px;">
                                        <span>交易订单编号：<?php echo $_GET['orderid'] ?></span>
                                    </div>
                                </div>
                                <div>
                                    <div class="flex flex-align-top" style="font-size: 14px; margin-top: 8px;"><span style="flex-shrink: 0; line-height: 22px;">买家收货信息：</span>
                                        <div class="flex flex-align-top">
                                            <div style="color: rgb(17, 17, 17); margin-right: 6px; font-size: 14px;"><span style="margin-right: 8px;">*************,*, ***********</span><span class="cursor-pointer"><i class="qn_iconfont cursor-pointer" style="color: var(--btn-text-primary-color, #999);"></i><button type="button" class="next-btn next-medium next-btn-primary next-btn-text" style="margin-left: 4px; margin-top: -6px;"><span class="next-btn-helper">显示</span></button></span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="flex flex-align-top flex-justify-end" style="min-width: 210px;">
                                <div class="color-text-link-primary cursor-pointer" aria-haspopup="true" aria-expanded="false" style="font-size: 14px;">查看发货/退货信息</div>
                                <div class="flex flex-align-center">
                                    <div style="margin-left: 12px; color: rgb(153, 153, 153); cursor: pointer; font-size: 14px;">
                                        <div class="flex flex-align-center"><i class="iconfont cursor-pointer" style="margin-right: 4px; font-size: 12px;"></i><span>旧版详情</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div>
                                <div class="flex">
                                    <div class="package-detail-container">
                                        <div style="font-size: 14px; font-weight: bolder; margin-top: 20px; margin-bottom: 12px;" data-spm-anchor-id="a21dvs.23850806.0.i1.536e678cTNzWnM">包裹明细</div>
                                        <div>
                                            <div class="flex flex-align-center" style="margin-bottom: 12px;">
                                                <div class="color-111 font-size-block-title flex flex-align-center" style="margin-bottom: 0px; margin-right: 5px;"><span class="align-right" style="width: 100px; flex-shrink: 0; margin-right: 10px;">
                                                        物流单号: </span><span><span style="white-space: pre-wrap; line-height: 1.5;"><?php echo $_GET['wldh'] ?></span></span></div>
                                            </div>
                                            <div class="color-111 font-size-block-title flex flex-align-center" style="margin-bottom: 12px;">
                                                <span class="align-right" style="width: 100px; flex-shrink: 0; margin-right: 10px;">物流公司: </span><span>
                                                    <span style="white-space: pre-wrap; line-height: 1.5;"><?php echo $_GET['kdmc'] ?></span></span>
                                            </div>
                                            <div class="color-111 font-size-block-title flex flex-align-center" style="margin-bottom: 12px;">
                                                <span class="align-right" style="width: 100px; flex-shrink: 0; margin-right: 10px;">发货时间: </span>
                                                <span><span style="white-space: pre-wrap; line-height: 1.5;"><?php echo $_GET['qrrq'] ?></span></span>
                                            </div>
                                            <div class="color-111 font-size-block-title flex flex-align-center" style="margin-bottom: 12px;">
                                                <span class="align-right" style="width: 100px; flex-shrink: 0; margin-right: 10px;">履约单号: </span><span>
                                                    <span style="white-space: pre-wrap; line-height: 1.5;">******************</span></span>
                                            </div>
                                            <div class="color-111 font-size-block-title flex flex-align-center" style="margin-bottom: 12px;"><span class="align-right" style="width: 100px; flex-shrink: 0; margin-right: 10px;">发货方式: </span><span><span style="white-space: pre-wrap; line-height: 1.5;">自己联系</span></span></div>
                                        </div>
                                        <div>
                                            <div class="color-111 font-size-block-title flex flex-align-top" style="margin-bottom: 12px;"><span class="align-right" style="width: 100px; flex-shrink: 0; margin-right: 10px;">包裹中的商品: </span>
                                                <div>
                                                    <div>
                                                        <div class="flex flex-justify-between flex-align-center">
                                                            <div class="flex flex-align-center" style="margin-right: 10px; margin-bottom: 10px;"><img src="<?php echo $_GET['flag'] == 1 ? $_GET['img'] : '//img.alicdn.com/bao/uploaded/i2/1583809483/O1CN01Kp7fG42JvGbhs3Bm4_!!0-item_pic.jpg_sum.jpg' ?> " width="48" height="48" style="border: 1px solid rgb(229, 229, 229); border-radius: 8px; overflow: hidden; flex-shrink: 0; margin-right: 10px;">
                                                                <div>
                                                                    <div>
                                                                        <div><a href="//trade.taobao.com/trade/detail/tradeSnap.htm?tradeId=2471980788827543757" target="_blank" rel="noreferrer"><?php echo $_GET['flag'] == 1 ? $_GET['name'] : '正常发货】PULMICORT 普米克令舒 吸入用布地奈德混悬液 2ml:1mg*5支/包cfy 哮喘' ?></a></div>
                                                                    </div>
                                                                    <div style="margin-top: 5px;"><span style="background: rgb(239, 244, 255); border-radius: 3px; font-size: 12px; padding: 2px 6px; margin: 0px 5px 5px 0px; color: rgb(17, 17, 17);"></span></div>
                                                                </div>
                                                            </div><span style="min-width: 30px; margin-top: -10px;">x <?php echo abs($_GET['sl']) ?></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div style="margin: 0px 30px; width: 1px; background: rgb(229, 229, 229);"></div>
                                    <div class="package-detail-container">
                                        <div style="display: flex;">
                                            <div style="font-size: 14px; font-weight: bolder; margin-bottom: 12px; margin-top: 20px;">物流动态</div>
                                            <div style="margin-left: 8px;"></div>
                                        </div>
                                        <div style="max-height: 400px; overflow: hidden auto;">
                                            <div class="package-logistic-info-no-status " style="font-size: 16px;"><img src="https://img.alicdn.com/imgextra/i2/O1CN01fLWJKO1slCDmUPbLH_!!6000000005806-55-tps-150-140.svg">
                                                <div style="margin-top: 16px;">无物流动态</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div id="consign-authentic-check-contaienr"></div>
            </div>
        </div>
    </div>
    ...
    <div class="fixorkbenchcontainer fixorkbenchcontainer-top">
        <div style="padding: 16px 20px; border-bottom: 1px solid rgb(230, 233, 237); background: rgb(255, 255, 255);">
            <div class="flex flex-align-center" data-spm-anchor-id="a21dvs.23850806.0.i1.4bbf678cpkuh5q">
                <div style="color: rgb(102, 102, 102); margin-right: 10px; cursor: pointer;">发货</div><i class="next-icon next-icon-arrow-right next-small" style="margin-right: 10px;"></i>
                <div>物流详情</div>
            </div>
        </div>
    </div>
